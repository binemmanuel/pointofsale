            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                        ...
                        <div class="row">
                                <div class="form-group col-md-6">
                                    <label>Message Type</label>
                                     <?php
                                        $bs = array('sms' => 'SMS',);
                                        echo form_dropdown('type', $bs, set_value('type', 'SMS'), 'class="form-control select2" id="type" required="required" style="width:100%;"');
                                      ?>
                                </div>
                                <div class="form-group col-md-6">
                        ...
                        <div class="form-group">
                            <?= form_submit('send_message', 'Create', 'class="btn btn-primary"'); ?>
                        </div>
