...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#prTables').DataTable({
            ...
            'ajax' : { url: '<?=site_url('products/get_productinventory/'.$store->id);?>', type: 'POST', "data": function ( d ) {
            ...
            "footerCallback": function (  tfoot, data, start, end, display ) {
                ...
                $(api.column(6).footer()).html( (api.column(6).data().reduce( function (a, b) { return pf(a) + pf(b); }, 0)) );
                    ...
                    <table id="prTables" class="table table-striped table-bordered table-hover" style="margin-bottom:5px;">
                        <thead>
                            <tr class="active">
                                ...
                                <th class="col-xs-2">Expiry Date</th>
                                <?php if ($Admin) { ?>
