                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <?= form_dropdown('rtl', $yn, $settings->rtl, 'class="form-control select2" id="rtl"'); ?>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class=""> <?php echo form_input('sms_senderid', $Settings->sms_senderid, 'class="form-control tip" id="sms_senderid"'); ?> </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>SMS Gateway Username</label>
                                    <div class=""> <?php echo form_input('sms_username', $Settings->sms_username, 'class="form-control tip" id="sms_username"'); ?> </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>SMS Gateway Password</label>
                                    <div class=""> <?php echo form_password('sms_password', $Settings->sms_password, 'class="form-control tip" id="sms_password"'); ?> </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
