        ...
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="treeview mm_products">
                 ...
                 <li class="treeview mm_stockadjustment">
                    <a href="#">
                        <i class="fa fa-barcode"></i>
                        <span>Inventory</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li id="products_index"><a href="<?= site_url('products/itemsinstock'); ?>"><i class="fa fa-circle-o"></i> Items In Stock</a></li>
                        <li id="products_index"><a href="<?= site_url('stockadjustment/add'); ?>"><i class="fa fa-circle-o"></i>Stock Inward/Outward</a></li>
                          <li id="products_index"><a href="<?= site_url('stockadjustment'); ?>"><i class="fa fa-circle-o"></i> All Stock Adjustments</a></li>
                    </ul>
                </li>
                ...
                <?php endif ?>
                    ...
                    <ul class="treeview-menu">
                        <li id="gift_cards_index"><a href="<?= site_url('messaging/templates'); ?>"><i class="fa fa-circle-o"></i>SMS Templates</a></li>
                        <li id="gift_cards_index"><a href="<?= site_url('messaging/newmessage'); ?>"><i class="fa fa-circle-o"></i> Send SMS</a></li>
                        <li id="gift_cards_add"><a href="<?= site_url('messaging/log'); ?>"><i class="fa fa-circle-o"></i>SMS Log</a></li>
                    </ul>
                </li>
