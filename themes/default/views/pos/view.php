                ...
                <div id="wrapper">
                    <div id="receiptData" style="width: auto; max-width: 580px; min-width: 250px; margin: 0 auto;">
                        ...
                        <div id="receipt-data">
                            ...
                            <div>
                                <?php if ($payment->pos_balance > 0 && $inv->baladdtowallet == 0): ?>
                                     <?= form_open('pos/addchangetowallet', 'id="addchangetowallet-form"'); ?>
                                        <input type="hidden" name="change" value="<?= $payment->pos_balance; ?>">
                                         <input type="hidden" name="customer" value="<?= $inv->customer_id; ?>">
                                          <input type="hidden" name="saleid" value="<?= $inv->id; ?>">
                                        <input type="submit" name="addchangetowallet" class="btn btn-danger btn-xs pull-right" value="Add Change to Wallet">
                                     <?= form_close(); ?>
                                <?php endif ?>
