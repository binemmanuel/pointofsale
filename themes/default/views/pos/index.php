                    ...
                    <tr>
                        <td style="width: 460px;">
                            ...
                            <div id="pos">
                                ...
                                <input type="hidden" id="storeaddress" name="" value="<?php echo $store->address1.'<br>'.'Tel: '.$store->phone.'<br>'.'Email: '.$store->email ;?>">
                                <div class="well well-sm" id="leftdiv">
                                            ...
                                            <div class="input-group">
                                               <?php foreach($customers as $customer){ $cus[$customer->id] = $customer->name.' ['.$this->tec->formatMoney($this->tec->accumulatedBalance($customer->id)).']'; } ?>
                                                ...
                                                <div class="input-group-addon no-print" style="padding: 2px 5px;">
                                                    <a href="#" id="add-customer" style="padding-right:10px;" class="external" data-toggle="modal" data-target="#myModal"><i class="fa fa-2x fa-plus-circle" id="addIcon"></i></a>
                                                    <a href="<?= site_url('sales/customerdeposit/'); ?>" id="customerdeporit" class="external" style="color: red;" data-toggle="ajax" ><i class="fa fa-2x fa-credit-card"></i></a>
                                                </div>
                                            </div>
                                            ...
                                            <table id="totaltbl" class="table table-condensed totals" style="margin-bottom:10px;">
                                                <tbody>
                                                    ...
                                                    <tr class="info">
                                                        ...
                                                        <td width="25%"><a href="#" id="add_tax" class="btn btn-default btn-sm">Service Charge</a></td>
                                    ...
                                    <div id="payment-con">
                                        ...
                                        <input type="hidden" name="addtowallet" id="addtowallet" value="">
...
<div class="modal" data-easein="flipYIn" id="tsModal" tabindex="-1" role="dialog" aria-labelledby="tsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title" id="tsModalLabel">Service Charge</h4>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="row">
                            <div class="col-xs-6">
                                        <div class="form-group">
                                        <?= lang("amount", "amount"); ?> <span id="wal" class="label label-warning"></span>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <?= form_input('address', set_value('address'), 'class="form-control input-sm" id="address"'); ?>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="form-group">
                            <label class="control-label" for="customerno">Customer No</label>
                            <?= form_input('customerno', set_value('customerno'), 'class="form-control input-sm" id="customerno"');?>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#spos_customer").on('change', function () {
                ...
                $.ajax({
                    url: '<?=site_url('customers/customerDetailsJson?custid=');?>' + custid,
                    method: 'GET',
                    data: '',
                    dataType: 'json',
                }).success(function (e) {
                    $('#customername').html(e.customer.name);
                    $('#walletbalance').html(e.customer.walletbalance);
                    $('#wal').html(e.customer.walletbalance);
