                            ...
                            <div>
                                ...
                                <table class="table table-striped table-condensed">
                                    ...
                                    <tfoot>
                                        ...
                                        <?php
                                        if ($inv->order_tax != 0) {
                                            echo '<tr><th style="text-align:left;">' . lang("order_tax") . '</th><th style="text-align:right;">' . $this->tec->formatMoney($inv->order_tax) . '</th></tr>';
                                        }
                                        if ($inv->total_discount != 0) {
                                            echo '<tr><th style="text-align:left;">' . lang("order_discount") . '</th><th style="text-align:right;">' . $this->tec->formatMoney($inv->total_discount) . '</th></tr>';
                                        }
                                        ...
                                        if ($Settings->rounding) {
                                            ...
                                            ?>
                                            <tr>
                                                <th style="text-align:left;"><?= lang("rounding"); ?></th>
                                                <th style="text-align:right;"><?= $this->tec->formatMoney($rounding); ?></th>
                                            </tr>
                                            <tr>
                                                <th style="text-align:left;"><?= lang("grand_total"); ?></th>
                                                <th style="text-align:right;"><?= $this->tec->formatMoney($inv->grand_total + $rounding); ?></th>
                                            </tr>
                                            <?php
                                        } else {
                                            ...
                                            <tr>
                                                <th style="text-align:left;"><?= lang("grand_total"); ?></th>
                                                <th style="text-align:right;"><?= $this->tec->formatMoney($inv->grand_total); ?></th>
                                            </tr>
                                            <?php
                                        }
                                        if ($inv->paid < $round_total) { ?>
                                        <tr>
                                            <th style="text-align:left;"><?= lang("paid_amount"); ?></th>
                                            <th style="text-align:right;"><?= $this->tec->formatMoney($inv->paid); ?></th>
                                        </tr>
                                        <tr>
                                            <th style="text-align:left;"><?= lang("due_amount"); ?></th>
                                            <th style="text-align:right;"><?= $this->tec->formatMoney($inv->grand_total - $inv->paid); ?></th>
                                        </tr>
                                        <?php } ?>
                                    </tfoot>
                                </table>
                                ...
                                if ($payments) {
                                    ...
                                    foreach ($payments as $payment) {
                                        ...
                                        if ($payment->paid_by == 'transfer' && $payment->amount) {
                                            echo '<td style="padding-left:15px;">' . lang("paid_by") . ': ' . lang($payment->paid_by) . '</td>';
                                            echo '<td style="padding-left:15px;">' . lang("amount") . ': ' . $this->tec->formatMoney($payment->pos_paid == 0 ? $payment->amount : $payment->pos_paid) . '</td>';
